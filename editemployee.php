...
<body>
    ...
    <div class="w3-auto">
        ...
        <br><br>
        <span class="w3-large">Edit Employee</span><br><br>
        <form id="frmEmployee">
            <div class="w3-row-padding">
                <div class="w3-col m6">
                    <div class="w3-row-padding w3-stretch">
                        <div class="w3-col l2">Name</div>
                        <div class="w3-col l6"><input type="text" name="empName" value="<?php echo $r['name']; ?>" id="empName" class="w3-input w3-border w3-round"></div>
                    </div>
                    <div class="w3-row-padding w3-stretch">
                        <div class="w3-col l2">DOB</div>
                        <div class="w3-col l6"><input type="date" name="empDob" value="<?php echo $r['dob']; ?>" id="empDob" class="w3-input w3-border w3-round"></div>
                    </div>
                    <div class="w3-row-padding w3-stretch">
                        <div class="w3-col l2">email</div>
                        <div class="w3-col l6"><input type="text" name="empEmail" value="<?php echo $r['email']; ?>" id="empEmail" class="w3-input w3-border w3-round"></div>
                    </div>
                    <div class="w3-row-padding w3-stretch">
                        <div class="w3-col l2">Contact</div>
                        <div class="w3-col l6"><input type="text" name="empContact" value="<?php echo $r['contact']; ?>" id="empContact" class="w3-input w3-border w3-round"></div>
                    </div>
                </div>
                <div class="w3-col m6">
                    <div class="w3-row-padding w3-stretch">
                    ...
                    <div class="w3-row-padding w3-stretch">
                        ...
                        <div class="w3-col l6"><input type="text" name="empAddress" value="<?php echo $r['address']; ?>" id="empAddress" class="w3-input w3-border w3-round"></div>
                    </div>
                    <div class="w3-row-padding w3-stretch">
            ...
            <div class="w3-center">
                <button type="button" onclick="editEmployee()" class="w3-button w3-blue w3-round">Edit</button>
    ...
    <script>
        const editEmployee = () => {
            ...
            $.ajax({
                url: "./api/main.php?editEmployee=<?php echo $_GET['id'] ?>",
                method: "POST",
                data: $("#frmEmployee").serialize(),
                success: (data) => {
                    // console.log(data);
                    if (data === "success") {
                        alert("employee status updated succesfully");
                        window.location.href = "./editemployee.php?id=<?php echo $_GET['id']; ?>"
